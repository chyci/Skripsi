...
<div class="col-xxl">
    ...
    <div class="card-body">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
            <textarea id="basic-default-message" placeholder="Hi, Do you have a moment to talk Joe?" aria-label="Hi, Do you have a moment to talk Joe?" aria-describedby="basic-icon-default-message2" name="massage"
            class="form-control @error('massage') invalid @enderror">
                @error('massage')
                <div class="form-text text-danger">{{ $message }}</div>
                @enderror
            </textarea>

                            ...
                            <tr>
                                ...
                                <td>
                                    <button type="button" class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                        data-bs-target="#changeRoleModal" data-userid="{{ $user->id }}">
                                        Change Role
                                    </button>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1">
        <div class="modal-dialog modal-sm">
            <form class="modal-content" method="POST">
                ...
                @method('DELETE')
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteModalTitle">Hapus User</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <h6 class="text-center text-bold">Apakah anda yakin ingin menghapus user ini?</h6>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal">
                        Batal
...
@push('js')
    <script type="text/javascript">
        ...
        $('#deleteModal').on('show.bs.modal', function(event) {
            ...
            var id = button.data('userid')
            var modal = $(this)
            modal.find('form').attr('action', '/user/destroy/' + id);
        });
    </script>
@endpush

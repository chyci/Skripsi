        ...
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    ...
                    <small class="text-muted float-end">edit obat</small>
                </div>
                <div class="card-body">
                    <form action="{{ route('drugentry.update', $drugentry->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" id="basic-default-name" value="{{ $drugentry->quantity }}"
                                        name="quantity" class="form-control @error('quantity') invalid @enderror">
                                    @error('quantity')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" type="date" value="{{ $drugentry->entry_date }}"
                                        id="html5-date-input" name='entry_date'
